...
import {delCurrency, getCurrencies, getCurrency, postCurrency} from "../../controllers/currencies.controller.js";
...
currencyRoutes.patch('/:uid', isUser, patchCurrencyValidator, postCurrency)
